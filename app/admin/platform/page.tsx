...
const s: Record<string, React.CSSProperties> = {
  ...
  subtitle: { fontFamily: font, fontSize: '6px', letterSpacing: '2.5px', color: '#4c1d95' },
  ...
  walletLabel: { fontFamily: font, fontSize: '5px', letterSpacing: '2px', color: '#4c1d95' },
  walletStatus: { fontFamily: font, fontSize: '6px', letterSpacing: '1px' },
  walletAddr: { fontFamily: font, fontSize: '6px', color: '#c084fc', letterSpacing: '0.3px', wordBreak: 'break-all' as const },
  wrongWalletNote: { fontFamily: font, fontSize: '5px', color: '#fca5a5', letterSpacing: '0.3px', lineHeight: 1.8, marginTop: '4px' },

  setupCard: { background: 'rgba(13,0,32,0.9)', border: '1px solid #1e0035', borderRadius: '12px', padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px' },
  setupTitle: { fontFamily: font, fontSize: '6px', letterSpacing: '2px', color: '#7c3aed' },
  setupGrid: { display: 'flex', flexDirection: 'column', gap: '8px' },
  setupRow: { display: 'flex', alignItems: 'flex-start', gap: '10px' },
  setupIcon: { fontFamily: font, fontSize: '7px', color: '#3b0764', flexShrink: 0, marginTop: '1px' },
  setupLabel: { fontFamily: font, fontSize: '5.5px', color: '#4c1d95', letterSpacing: '0.5px', flex: 1 },
  setupValue: { fontFamily: font, fontSize: '7px', color: '#c084fc', textAlign: 'right' as const },
  setupNote: { fontFamily: font, fontSize: '4.5px', color: '#3b0764', textAlign: 'right' as const, letterSpacing: '0.3px', marginTop: '2px' },
  setupMeta: { borderTop: '1px solid #1e0035', paddingTop: '10px', display: 'flex', flexDirection: 'column', gap: '6px' },
  metaRow: { display: 'flex', justifyContent: 'space-between', gap: '8px' },
  metaKey: { fontFamily: font, fontSize: '5px', color: '#3b0764', letterSpacing: '0.5px' },
  metaVal: { fontFamily: font, fontSize: '5px', color: '#7c3aed', letterSpacing: '0.5px' },
  ...
  previewNote: { fontFamily: font, fontSize: '4.5px', color: '#3b0764', letterSpacing: '0.3px' },
  ...
  addr: { fontFamily: font, fontSize: '5.5px', color: '#c084fc', letterSpacing: '0.3px', wordBreak: 'break-all' as const, flex: 1 },
  ...
  envCard: { background: 'rgba(13,0,32,0.7)', border: '1px solid #1e0035', borderRadius: '8px', padding: '14px', display: 'flex', flexDirection: 'column', gap: '12px' },
  ...
  envInstruction: { fontFamily: font, fontSize: '5px', color: '#4c1d95', letterSpacing: '0.5px' },
  ...
  createNote: { fontFamily: font, fontSize: '5px', color: '#3b0764', letterSpacing: '0.3px', textAlign: 'center' as const, lineHeight: 1.8 },
  ...
  copyBtn: { fontFamily: font, fontSize: '5px', letterSpacing: '1px', color: '#c084fc', background: 'transparent', border: '1px solid #3b0764', borderRadius: '4px', padding: '4px 8px', cursor: 'pointer', flexShrink: 0 },
